...
DATABASES = {
    'default': {
        ...
        'HOST': 'projectdatabase.c5iecsqxblja.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-bucket-yusuf' # please enter your s3 bucket name
